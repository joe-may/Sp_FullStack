...
$('.countDown').click(function(){
 ...
 render() {
  ...
  <div class='pinkBoxAndGif'>
      <div class='pinkBox'>
        <img src='../StudyPup_assets/Hotsva_HotSauce_Box1.png' alt=""  class='bbox'/>
        <div class="problem reset"></div>
        </div>
        <img src='../StudyPup_assets/Hotsva_HotSauce_Propellers.gif' alt=""  class='spinner'/>
     </div>
  
     <div class="brownBox">
      <button class="create">CREATE</button>
      <img src='../StudyPup_assets/Hotsva_HotSauce_Box2.png' alt="" class='ybox'/>
       <div class="guessCounter">
          ...
          <img src='../StudyPup_assets/Hotsva_HotSauce_Smoke.gif'alt=""  class='smokers'/>
