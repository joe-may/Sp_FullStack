...
class SnowConb3 extends Component {
  componentDidMount() {
    $('audio#snoconSong')[0].play();
        ...
        render() {
          return (
            <div className="landingb3" style ={ { backgroundImage: "url('https://studypupassets.s3-us-west-1.amazonaws.com/StudyPup_assets/Background_Galaxy.png')"} }>
            <audio id="snoconSong">
                ...
                <a href="/sno2">
                <img class="blueLevel3" src="https://studypupassets.s3-us-west-1.amazonaws.com/StudyPup_assets/Snow-con_Level3_Complete.png"alt=""/>
                </a>
                <img class="wind" src="https://studypupassets.s3-us-west-1.amazonaws.com/StudyPup_assets/Snow-con_Level4_Deco.gif" alt=""/>

                <a href="/bbsno1">
                <img class="bossLevel1" src="https://studypupassets.s3-us-west-1.amazonaws.com/StudyPup_assets/Snow-con_Level4_On.png"alt=""/>
                </a>
