...
class ArcadePaged extends Component {
  ...
  render() {
    return (
      <div class="arcadePaged" style ={ { backgroundImage: "url('https://studypupassets.s3-us-west-1.amazonaws.com/StudyPup_assets/BG_Purple_Pattern_niew.png')"} }>
          <Router>
